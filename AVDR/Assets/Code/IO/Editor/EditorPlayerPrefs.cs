...
{
    [MenuItem("AVDR/Clear Player Prefs", priority = 1)]
    static void ClearPlayerPrefs() {
        Debug.LogWarning("Clearing PlayerPrefs");
        PlayerPrefs.DeleteAll();
    }

    [MenuItem("AVDR/Dump character data to Clipboard", priority = 2)]
    ...
    [MenuItem("AVDR/Dump history data to Clipboard", priority = 3)]
